...
When you connect GA4 to Claude via MCP, you can ask plain-English questions about your live campaign data and get answers instantly, with no dashboard, no exports, and no tab-switching. During the 2026 FIFA World Cup (11 June-19 July), that speed matters: 48 teams, 104 matches, and audience attention shifting by the hour. This guide covers how to connect GA4 to Claude Desktop via MCP and which queries to run to stay on top of campaign performance throughout the tournament.

## Why Campaign Tracking Gets Harder When Everyone Is Watching

Major live events compress the attention economy. During a World Cup match, organic search patterns shift, paid campaigns compete against higher CPMs, and landing page traffic can spike or collapse within minutes of a final whistle. You do not monitor one campaign. You watch several simultaneously while the audience's behavior changes underneath them.

The standard workflow, logging into GA4, building a report, exporting it, and pasting it into a document, takes too long when conditions move fast. By the time a manually assembled report lands in a chat or meeting, the data it describes has already changed.
...
The Model Context Protocol (MCP) creates a direct, authenticated connection between Claude Desktop and the Google Analytics Data API. When you ask Claude a question, it calls your GA4 property directly and returns the answer in your conversation, with no intermediary, no third-party service, and no export required.
...
If you start from scratch, that guide covers the full setup. Here is a summary of what it involves:

**What you need:**
- Claude Desktop (Mac), downloaded from [claude.ai/download](https://claude.ai/download)
...
Claude lists your GA4 accounts and properties. Once your property name appears, you are ready to query.
...
If you already query your World Cup campaigns in Claude, adding the Sheets MCP turns those queries into a shareable, updatable report in one extra step.
