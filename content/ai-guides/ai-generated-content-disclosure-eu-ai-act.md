...
The EU AI Act's transparency obligations under Article 50 apply from **2 August 2026** — and if you publish AI-generated content professionally, you have specific disclosure duties that go well beyond adding a footnote to your terms and conditions. The European Commission has published [draft guidelines](https://digital-strategy.ec.europa.eu/en/library/draft-guidelines-implementation-transparency-obligations-certain-ai-systems-under-article-50-ai-act) explaining exactly what those disclosures must look like, where they must appear, and what will not meet the standard. This guide translates those requirements into practical placement guidance for content creators, freelancers, and science communicators.
