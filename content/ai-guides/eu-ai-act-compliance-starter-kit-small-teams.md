...
- A list of the AI tools and systems your team actually uses or builds.
- For each one, a one-line note on what it does and who it affects.
- The [official AI Act text](https://eur-lex.europa.eu/eli/reg/2024/1689/oj/eng) and the [AI Act Service Desk](https://ai-act-service-desk.ec.europa.eu/) open in a tab for reference.
...
The Act applies in stages, and the 2026 Digital Omnibus adjusted the high-risk dates. The current picture:

| Date | What applies |
|---|---|
| 2 February 2025 | Prohibited practices (Article 5) |
| 2 August 2025 | General-purpose AI model rules |
| 2 December 2026 | Extended transitional deadline for marking AI-generated content (pre-market systems) |
