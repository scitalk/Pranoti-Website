---
title: "AI Disclosure"
description: "How AI tools are used in producing content on pranoti.thesciencetalk.com, and how that maps to Article 50 of the EU AI Act."
layout: "single"
draft: false
---

I write about AI integration, so it would be strange not to say plainly how I use it here.
...
- **Your data.** No personal data of site visitors is entered into AI systems. See the [Privacy Policy](/privacy/).
...
- No chatbot or conversational AI system runs on this site. Were one added, it would identify itself as an AI system at the start of the conversation, as **Article 50(1)** requires.
- No emotion recognition or biometric categorisation system is used (**Article 50(3)**).
- No deepfakes or manipulated depictions of real people are published (**Article 50(4)**).
